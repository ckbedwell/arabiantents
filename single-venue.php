          ...
          <? if (get_the_content()) : ?>
            ...
            if (!empty($images)) : ?>
              <div class="gallery tiered-gallery half">
                ...
                <a class="lightbox-link" href="<?= $imgURL; ?>" caption="<?= $captionText; ?>">
                  <div class='full display-card featured-image point-five-trans' data-bg="<?= $imgURL; ?>"></div><button class="pinterest-btn" onclick="window.open('//pinterest.com/pin/create/link/?url=<?= 'http://' . $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI']; ?>&media=<?= $featuredImage['full_url']; ?>&description=<?= get_the_excerpt(); ?>','_blank','resizable=yes'); event.stopPropagation(); event.preventDefault();">Save</button>
                </a>
                <noscript>
                  <a class="lightbox-link" href="<?= $imgURL; ?>" caption="<?= $captionText; ?>">
                    <div class='full display-card featured-image point-five-trans' style='background-image: url("<?= $imgURL; ?>");'></div>
                  </a>
                </noscript>

                ...
                <div class="full no-padding furniture-grid gallery" id="results">
                    ...
                    <? if ($furniture->have_posts()) { ?>
                        <? while ($furniture->have_posts()) : ?>
                            ...
                            <a class="lightbox-link masonry-item image-link <? foreach((array) $furniture_types as $term) { echo $term->slug . " "; } foreach((array) $color as $term) { echo $term->slug . " ";} ?>" href="<?= $imgURL; ?>" caption="<? the_title(); ?>">

...
<!DOCTYPE html>
<html <? language_attributes(); ?> class="<? if (isset($active)) {
                                            echo $active;
                                          } ?> no-js" id="html">
...
<head>
  ...
  <script>
    ...
    })(window, document, 'script', 'dataLayer', 'GTM-WJPMVD5');
  </script>
      ...
      <div class="width-contain width-contain-750-mob">
        <div class="site-branding point-three-trans aligncenter">
          <a class="point-three-trans image-link" href="<?= esc_url(home_url('/')); ?>" rel="home">
            <img class="point-three-trans" src="wp-content/themes/arabiantents/images/atc-rectangle.png" title="<? bloginfo('name'); ?>" alt="<? bloginfo('name'); ?>">
          </a>
        </div>
      </div>

...
class digicrab_three_fifty_blocks_slide_widget extends WP_Widget
{
    ...
    function widget($args, $instance)
    {
        ...
        // if the image is set
        if ($image) {
            echo '<a class="featured-image" style="background-image: url(' . $image . ');" href="' . $link . '" " alt="' . $alttag . '" title="' . $alttag . '"/>';
        }

        echo '<div class="parent-contain"><div class="width-contain"><div class="content-wrapper">';
        ...
        if ($linktext) {
            echo '<p class="cta" href="' . $link . '">' . $linktext . '</p>';
        }

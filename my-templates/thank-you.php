...
if ($which_form == "FAQ - Ask a Question") {
    $question = true;
    $thanksText = "Thank you for your question";
    }

elseif($which_form == "Feedback Form") {
    $feedback = true;
    ...
    $enquiry = true;
    $thanksText = "Thank you for your enquiry";
    }
?>
	...
	<main id="post-<? the_ID(); ?>" <? post_class('site-main, point-five-trans'); ?> role="main">
        <header class="row-padding entry-header">
            <div class="height-filler"></div>
            <div class="vertical-align full">
                <div class="width-contain text-center">
                    <h1 class="entry-title"><?= $thanksText; ?></h1>
                    <p>We have sent a confirmation of your message to the email you have provided (<?= $field_email; ?>).</p>
                    <p>We will be in touch shortly.</p>
                    <a href="/didnt-receive-email" class="more-info small" value="didnt-receive-email">What if you didn't receive a confirmation email?</a>
                </div>
            </div>
        </header>
        ...
        <div class="entry-content scrollto-padding" id="scrollto-entry-content">
            ...
            <? if($enquiry) : ?>
                <section class="entry-content">
                    <div class="width-contain text-center quick-navigation">

                        <h3>Have you thought about any of these for your event?</h3>
                            <?
                        $args = array (
                            'post_type' => 'page',

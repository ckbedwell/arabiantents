        ...
        <article>
                      ...
                      <div class="width-contain">
                         ...
                         <div class="three-quarters">
                             <h1 class="entry-title"><? the_title(); ?></h1>
                              <h2>Photographer</h2>
                             <? $officeNumber = rwmb_meta ('photographer-office', 'type=text'); if(!empty($officeNumber)) : ?>
                                   <p><strong>Phone Number:</strong> <?= $officeNumber; ?></p>
                              <? endif; ?>

                              <? $mobile = rwmb_meta ('photographer-mobile', 'type=text'); if(!empty($mobile)) : ?>
                                   <p><strong>Mobile:</strong> <?= $mobile; ?></p>
                              <? endif; ?>

                              <? $email = rwmb_meta ('photographer-email', 'type=text'); if(!empty($email)) : ?>
                              <p><strong>Email:</strong> <a href="mailto:<?= $email; ?>"><?= $email; ?></a></p>
                              <? endif; ?>

                              <? $website = rwmb_meta ('photographer-website', 'type=text'); if(!empty($website)) : ?>
          ...
          <div class="scrollto-padding" id="scrollto-entry-content">
               ...
               <section>
                    <div class="width-contain">
                         <div class="half">
                             <? $question1 = rwmb_meta ('photographer-q1', 'type=text'); if(!empty($question1)) : ?>
                                  <div class="full">
                             ...
                             <? $question2 = rwmb_meta ('photographer-q2', 'type=text'); if(!empty($question1)) : ?>
                                  <div class="full">
                             ...
                             <? $question3 = rwmb_meta ('photographer-q3', 'type=text'); if(!empty($question1)) : ?>
                                  <div class="full">
                             ...
                             <? $question4 = rwmb_meta ('photographer-q4', 'type=text'); if(!empty($question1)) : ?>
                                  <div class="full">

...
<div class="more-info-overlay width-contain hide fade-in tent-faqs">
   <a class="icon-cross close" title="Close Information Box"><span>Close</span></a>
   <div class="wrapper">
      <div class="third side-info questions">
         <h3 class="row-padding-small no-margin text-center">Frequently Asked Questions</h3>
         <ul>
            <li class="active">
            ...
            <li class="text-center ask">
               <a href="#answer9">Ask a question</a>
            </li>
         </ul>
      </div>
      <div class="two-thirds answers">
         <div class="alignleft full wrapper">
            <div class="row-padding answer" id="answer1">
               ...
               <div class="row-padding-small max-capacity-info">
                  <? include(locate_template('/partials/overlays/max-capacity.php')); ?>
               </div>
            </div>

            <div class="row-padding answer" id="answer2">
            ...
            <div class="row-padding answer" id="answer3">
            ...
            <div class="row-padding answer" id="answer4">
            ...
            <div class="row-padding answer" id="answer5">
            ...
            <div class="row-padding answer" id="answer6">
            ...
            <div class="row-padding answer" id="answer7">
            ...
            <div class="row-padding answer" id="answer8">
               ...
               <?
                  ...
                  while($examples->have_posts()) : ?>
                     ...
                     ?>
                        <div class="alignleft full row-padding-small gallery price-example">
                           <div class="half-margined no-padding">
                              <a href="<?= $featuredImage['full_url']; ?>" class="image-link lightbox-link" caption="<?= get_the_content(); ?>">
            ...
            <div class="row-padding answer" id="answer9">
               <h4>Ask if there is anything else you would like to know</h4>
               <p>If you have any other question, big or small, just ask away. We are happy to answer any queries you may have.</p>
               <? get_template_part('/partials/enquiry-forms/ask-a-question'); ?>
            </div>
         </div>
      </div>
   </div>
...
<script>
   ...
   jQuery('.questions a').click(function() {

      var value = jQuery(this).attr('href');
      var target = jQuery(value).position().top;
      jQuery('.answers').stop().animate({
         scrollTop: target
         }, 500);
      return false;
      });
   ...
   jQuery('.answers').scroll(function() {
      ...
      answers.each(function(){
         ...
         currentAnswer = jQuery(this);
         if(divPosition < currentScroll) {

            var id = currentAnswer.attr('id');
            jQuery('.questions a').parent().removeClass('active');
            jQuery(".questions [href='#"+id+"']").parent().addClass('active');
            }

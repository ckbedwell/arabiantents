...
<section
  class="parent-contain entry-content call-to-action"
  data-bg="<? if ($image) {
                                                                        echo wp_get_attachment_image_url($image, 'full');
                                                                      } else {
                                                                        echo '/wp-content/uploads/2015/07/display21-20140906195126_7_7-2_fused.jpg';
                                                                      } ?>"
                                                                      >
...
<noscript>
  <section class="parent-contain entry-content call-to-action" style="background-image: url(
      <? if ($image) {
        echo wp_get_attachment_image_url($image, 'full');
      } else {
        echo '/wp-content/uploads/2015/07/display21-20140906195126_7_7-2_fused.jpg';
